...
void Application::Init()
{
	...
	assetMan->CreateMaterial("spritesheet", assetMan->GetTexture("othersheet"), assetMan->GetTexture("defaultNormal"), assetMan->GetTexture("defaultSpecular"), assetMan->GetShaderProgram("def"));
